...
#save model
#name typo, 'elu' should be prelu, I changed it manually...
...
from sklearn.metrics import mean_squared_error
import autoencoder_pytorch_peak_loss

model = AutoEncoder()
model.load_state_dict(torch.load(NAME))
model.cuda()
training_peak_loss, test_peak_loss =  autoencoder_pytorch_peak_loss.peak_loss(model, training_set, test_set)
